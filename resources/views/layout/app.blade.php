...
<head>
    ...
    <style>
        ...
        .sidebar { position: fixed; top: 0; bottom: 0; left: 0; z-index: 100; padding: 48px 0 0; box-shadow: inset -1px 0 0 rgba(0, 0, 0, .1); overflow-y: auto; transition: margin 0.3s ease-in-out; }
        ...
        .navbar-toggler-desktop { display: none; color: rgba(255, 255, 255, 0.55); border: none; }
        .navbar-toggler-desktop:hover { color: rgba(255,255,255,.75); }
        @media (min-width: 768px) {
            .navbar-toggler-desktop { display: block; margin-left: 10px; }
            .navbar-toggler-mobile { display: none; }
        }
        #main-wrapper.sidebar-collapsed #sidebarMenu { margin-left: -100%; }
        #main-wrapper.sidebar-collapsed main { width: 100%; margin-left: 0; }

        /* [BARU] Style untuk user dropdown di navbar */
        .navbar .nav-item .nav-link { color: rgba(255,255,255,.55); }
        .navbar .nav-item .nav-link:hover { color: rgba(255,255,255,.75); }
    </style>
</head>
<body>
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{ route('dashboard') }}">
        <img src="https://via.placeholder.com/30x24/FFFFFF/000000?text=LOGO" alt="Logo" width="30" height="24" class="d-inline-block align-text-top me-2" style="background-color: white; border-radius: 4px;">
        Proyek Inventaris
    </a>
    
    <button class="navbar-toggler navbar-toggler-mobile position-absolute d-md-none collapsed" 
