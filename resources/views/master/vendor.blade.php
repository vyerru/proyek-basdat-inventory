...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form action="{{ route('master.vendor') }}" method="GET" class="d-flex justify-content-between align-items-center">
            <div class="col-md-4">
                ...
                <select id="status" name="status" class="form-select" onchange="this.form.submit()">
                    ...
                    <option value="Semua Vendor" {{ $status_terpilih == 'Semua Vendor' ? 'selected' : '' }}>Semua Vendor</option>
                </select>
            </div>
            <div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($vendor->status_vendor == 'Aktif')
                            <form action="{{ route('master.vendor.destroy', $vendor->idvendor) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menonaktifkan vendor ini?');">
                                @csrf
                                @method('DELETE')
