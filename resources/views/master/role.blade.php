                    ...
                    <tbody>
                        @forelse ($data_role as $role)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('master.role.edit', $role->idrole) }}" class="btn btn-warning btn-sm">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('master.role.destroy', $role->idrole) }}" method="POST"
                                        onsubmit="return confirm('PERHATIAN: Menghapus role bisa merusak data user. Anda yakin?');">
                                        @csrf
                                        @method('DELETE')
