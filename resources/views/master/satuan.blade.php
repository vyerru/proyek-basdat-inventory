...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form action="{{ route('master.satuan') }}" method="GET" class="d-flex justify-content-between align-items-center">
            <div class="col-md-4">
                ...
                <select id="status" name="status" class="form-select" onchange="this.form.submit()">
                    ...
                    <option value="Semua Satuan" {{ $status_terpilih == 'Semua Satuan' ? 'selected' : '' }}>Semua Satuan</option>
                </select>
            </div>
            <div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($satuan->status_satuan == 'Semua Satuan')
                            <form action="{{ route('master.satuan.destroy', $satuan->idsatuan) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menonaktifkan satuan ini?');">
                                @csrf
                                @method('DELETE')
