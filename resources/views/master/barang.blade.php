            ...
            <form action="{{ route('master.barang') }}" method="GET"
                ...
                <div class="col-md-4">
                    ...
                    <select id="status" name="status" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="Semua Barang" {{ $status_terpilih == 'Semua Barang' ? 'selected' : '' }}>Semua Barang
                        </option>
                    </select>
                </div>
                <div>
                    ...
                    <tbody>
                        @forelse ($data_barang as $barang)
                            <tr>
                                ...
                                <td>
                                    @if($barang->status_barang == 'Aktif')
                                        <a href="{{ route('master.barang.edit', $barang->idbarang) }}"
                                            class="btn btn-warning btn-sm">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <form action="{{ route('master.barang.destroy', $barang->idbarang) }}" method="POST"
