...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form action="{{ route('master.margin') }}" method="GET" class="d-flex justify-content-between align-items-center">
            <div class="col-md-4">
                ...
                <select id="status" name="status" class="form-select" onchange="this.form.submit()">
                    ...
                    <option value="Semua Margin" {{ $status_terpilih == 'Semua Margin' ? 'selected' : '' }}>Semua Margin</option>
                </select>
            </div>
            <div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($margin->status_margin == 'Aktif')
                            <form action="{{ route('master.margin.destroy', $margin->idmargin_penjualan) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menonaktifkan margin ini?');">
                                @csrf
                                @method('DELETE')
